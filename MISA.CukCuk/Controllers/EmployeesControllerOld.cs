...
namespace MISA.CukCuk.Controllers
{
    ...
    //    public EmployeesControllerOld(IConfiguration config)
    //    {
    //        _config = config;

    //        // Lấy thông tin truy cập db
    //        /*_connectionString = _config.GetValue<string>("ConnectionString:CukCukDatabase");*/

    //        _connectionString = "Host = 47.241.69.179;Database = WEB07.MF941.TTANH.CukCuk; User Id = dev; Password = 12345678;";
    ...
    //    {
    //        // Lấy dữ liệu
    //        var sqlQuery = "SELECT * FROM Employee ORDER BY CreatedDate DESC";
    ...
    //    /// <param name="employeeFilter"> Chuỗi cần tìm kiếm</param>
    //    /// <returns></returns>
    //    [HttpGet("employeeFilter")]
    //    public IActionResult GetEmployeeFilter(int pageSize, int pageNumber,
    //                                            string employeeFilter, string departmentId, string positionId)
    //    {
    ...
    //        parameters.Add("@filter", employeeFilter.ToUpper());
    ...
    //            if (propName == "PositionName"
    //                || propName == "PositionCode"
    //                || propName == "DepartmentName"
    //                || propName == "DepartmentCode"
    //                || propName == "QualificationName"
    //                || propName == "Description"
    //                || propName == "GenderName") continue;
